export const API_ENDPOINTS = {
    ...
    patients: {
        ...
        searchDoctorBySpecialty: (specialty) =>  `/patients/search/${specialty}/name`,
        filterBySpecialty: (specialty) => `/patients/search/${specialty}`,
        viewDoctorProfile: (doctorId) => `/patients/doctors/${doctorId}`,
        ...
        createConsultation: (doctorId) => `/patients/consultations/booking/${doctorId}`,
    },
    doctors: {
